                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <form id="addPrinting" onsubmit="makeRequest(event);">
                                ...
                                <div class="mb-3 row">
                                    <label for="no_laminating" class="col-sm-4 col-form-label">No Laminasi:</label>
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control" id="no_laminating" name="no_laminating" onchange="printPreview();" required>
                                    </div>
                                </div>
                                <div class="mb-3 row">
                        ...
                        <div class="col-md-6 bg-light">
                            ...
                            <div class="overflow-y-auto" style="height: 50vh;">
                                <div id="print-area" class="bg-white" style="min-height: 1000px;">
                                    ...
                                    <div class="row">
                                        <div class="col-4 d-flex justify-content-between">
                                            <span>No. Laminasi</span>
                                            <span>:</span>
                                        </div>
                                        <div class="col-8">
                                            <span id="prev_no_laminating"></span>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-4 d-flex justify-content-between">
...
<script>
    ...
    function clearField() {
        ...
        var noLaminatingInput = document.getElementById("no_laminating");
    ...
    function clearPrev() {
        ...
        var prevNoPrinting = document.getElementById("prev_no_laminating");
    ...
    function printPreview() {
        ...
        prevNoPrinting.textContent = noLaminatingInput.value;
    ...
    function makeRequest(e) {
        ...
        var noLaminatingInput = document.getElementById("no_laminating").value;
        ...
        jQuery.ajax({
            url: '<?php echo base_url('user/laminating/add'); ?>',
            type: "POST",
            data: {
                tanggal: tanggalInput,
                no_ik: noIkInput,
                nama_barang: namaBarangInput,
                no_laminating: noLaminatingInput,
    ...
    function refreshTable() {
        showLoadingSpinner();
        jQuery.ajax({
            url: '<?php echo base_url('user/getLaminatings'); ?>',
            dataType: "json",
            success: function(response) {
    ...
    function deleteOne(id) {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                showLoadingSpinner();
                jQuery.ajax({
                    url: '<?php echo base_url('user/laminating/'); ?>' + id,
                    type: "DELETE",
                    success: function(response) {
                        refreshTable();
                        console.log(response)
    ...
    function updateLaminating(id, e) {
        e = e || window.event
        e.preventDefault();
        showLoadingSpinner();
    ...
    function editForm(id) {
        showLoadingSpinner();
        jQuery.ajax({
            url: '<?php echo base_url('user/getLaminating/'); ?>' + id,
            type: "GET",
            success: function(response) {
                // console.log(response)
                hideLoadingSpinner();
    ...
    function fillForm(data) {
        ...
        noLaminatingInput.value = data.no_laminating
