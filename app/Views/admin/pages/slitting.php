    ...
    <div class="row mb-4">
        <div class="card border-primary mb-3">
            ...
            <div class="card-body text-primary">
                <!-- <button class="btn btn-primary shadow" type="button" data-bs-toggle="modal" data-bs-target="#tambahModal" data-bs-whatever="@mdo"><i class="bx bx-plus"></i>Tambah</button> -->
...
<script>
    ...
    function prints() {
        ...
        for (var page = 0; page < pageCount; page++) {
            ...
            for (var i = startIndex; i < endIndex; i++) {
                ...
                html += '<div class="row">';
                html += '<div class="col-4 d-flex justify-content-between">';
                html += '<span>Hasil FG Riwen</span>';
                html += '<span>:</span>';
                html += '</div>';
                html += '<div class="col-8">';
                html += '<span id="prev_jumlah_meter">' + item.column7 + '</span>';
                html += '</div>';
                html += '</div>';
                html += '<div class="row">';
                html += '<div class="col-4 d-flex justify-content-between">';
                ...
                html += '</div>';
                html += '<div class="col-8">';
                html += '<span id="prev_jumlah_meter">' + item.column8 + '</span>';
                html += '</div>';
                html += '</div>';
                html += '</div>';
    ...
    function refreshTable() {
        showLoadingSpinner();
        jQuery.ajax({
            url: '<?php echo base_url('admin/getSlittings'); ?>',
            dataType: "json",
            success: function(response) {
